			...
			<table width="100%"  border="1">
				<tr>
						...
						<td>
							<li>
								<ul>
									<img src="https://pbs.twimg.com/profile_images/790963803043209217/dDKfKuFy.jpg" width="40px"><a href="">Nome do escoria</a>
									<input type="button" name="aceitar" value="aceitar escória">
									<input type="button" name="recusar" value="recusar escória">
								</ul>
							</li>
						</td>
				</tr>
